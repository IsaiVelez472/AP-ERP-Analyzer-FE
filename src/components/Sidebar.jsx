      ...
      <nav className="p-6 w-full flex flex-col flex-wrap">
        <ul className="space-y-1.5">
          <li>
            <Link
              className={`flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 ${
                currentPath === "/finance" ? "bg-gray-100" : ""
              }`}
              to="/finance"
            >
              <svg
          ...
          <li>
            <Link
              className={`flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 ${
                currentPath === "/operations" ? "bg-gray-100" : ""
              }`}
              to="/operations"
            >
              <svg
          ...
          <li>
            <Link
              className={`flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 ${
                currentPath === "/administrative" ? "bg-gray-100" : ""
              }`}
              to="/administrative"
            >
              <svg
          ...
          <li>
            <Link
              className={`flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 ${
                currentPath === "/documentation" ? "bg-gray-100" : ""
              }`}
              to="/documentation"
            >
              <svg
