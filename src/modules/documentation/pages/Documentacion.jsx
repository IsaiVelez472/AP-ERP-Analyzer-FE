...
function Documentacion() {
  ...
  const fasesConstruccion = [
    {
      ...
      descripcion:
        "Fase inicial donde identificamos el problema y definimos la solución.",
      actividades: [
    ...
    },
    {
      ...
      descripcion:
        "Creación de prototipos y definición de la experiencia de usuario.",
      actividades: [
  ...
  const arquitecturaTecnica = {
    frontend: {
      ...
      descripcion:
        "Interfaz de usuario moderna y responsiva con componentes reutilizables.",
      caracteristicas: [
      ...
      {activeTab === "proceso" && (
        <div className="space-y-6">
          <div className="bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 mb-6">
            ...
            <p>
              Metodología ágil con ciclos de desarrollo iterativos de 2 días
              para la hackathon.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            {fasesConstruccion.map((fase) => (
              <div key={fase.id} className="mb-8 flex items-start">
                {/* Icono de la fase */}
                <div
                  className={`relative z-10 flex items-center justify-center w-16 h-16 rounded-full ${fase.bgColor} ${fase.borderColor} border-2 shadow-md mr-4`}
                >
                ...
                <div className="flex-1">
                  <div
                    className={`p-5 rounded-lg shadow-sm border ${fase.borderColor} bg-white`}
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3 className={`text-lg font-bold ${fase.color}`}>
                        {fase.titulo}
                      </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border rounded-lg shadow-sm p-5">
            ...
            <p className="text-gray-600 mb-4">
              AP-ERP Analyzer utiliza una arquitectura moderna basada en
              microservicios, con separación clara entre frontend y backend,
              permitiendo escalabilidad y mantenimiento independiente de los
              componentes.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white border rounded-lg shadow-sm p-5">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800">
                  {arquitecturaTecnica.frontend.titulo}
                </h3>
              </div>
              <p className="text-gray-600 mb-3">
                {arquitecturaTecnica.frontend.descripcion}
              </p>
              ...
              <ul className="space-y-1">
                {arquitecturaTecnica.frontend.caracteristicas.map(
                  (caracteristica, idx) => (
                    <li
                      key={idx}
            ...
            <div className="bg-white border rounded-lg shadow-sm p-5">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800">
                  {arquitecturaTecnica.backend.titulo}
                </h3>
              </div>
              <p className="text-gray-600 mb-3">
                {arquitecturaTecnica.backend.descripcion}
              </p>
              ...
              <ul className="space-y-1">
                {arquitecturaTecnica.backend.caracteristicas.map(
                  (caracteristica, idx) => (
                    <li
                      key={idx}
                      className="text-sm text-gray-600 flex items-start"
            ...
            <div className="bg-white border rounded-lg shadow-sm p-5">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800">
                  {arquitecturaTecnica.integraciones.titulo}
                </h3>
              </div>
              <p className="text-gray-600 mb-3">
                {arquitecturaTecnica.integraciones.descripcion}
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {arquitecturaTecnica.integraciones.tecnologias.map(
                  (tech, idx) => (
                    <span
                      key={idx}
              ...
              <ul className="space-y-1">
                {arquitecturaTecnica.integraciones.caracteristicas.map(
                  (caracteristica, idx) => (
                    <li
                      key={idx}
                      className="text-sm text-gray-600 flex items-start"
            ...
            <div className="bg-white border rounded-lg shadow-sm p-5">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-bold text-gray-800">
                  {arquitecturaTecnica.despliegue.titulo}
                </h3>
              </div>
              <p className="text-gray-600 mb-3">
                {arquitecturaTecnica.despliegue.descripcion}
              </p>
              ...
              <ul className="space-y-1">
                {arquitecturaTecnica.despliegue.caracteristicas.map(
                  (caracteristica, idx) => (
                    <li
                      key={idx}
                      className="text-sm text-gray-600 flex items-start"
      ...
      {activeTab === "recursos" && (
        <div className="space-y-6">
          <div className="bg-white border rounded-lg shadow-sm p-5">
            ...
            <p className="text-gray-600 mb-4">
              Documentos y recursos relacionados con el desarrollo y uso de
              AP-ERP Analyzer.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 border rounded-lg flex items-center hover:bg-gray-50 transition-colors">
                ...
                <div className="text-sm text-gray-500">PDF • 3.8 MB</div>
              </div>
              ...
              <div className="p-4 border rounded-lg flex items-center hover:bg-gray-50 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Pitch deck utilizado en la presentación
                  </p>
                </div>
                <div className="text-sm text-gray-500">PPTX • 5.1 MB</div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Conjunto de datos para testing
                  </p>
                </div>
              </a>
