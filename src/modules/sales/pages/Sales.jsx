    ...
    return [
      {
        ...
        searchableContent: `Total Sales ${formatNumber(salesData.total_sales_amount)}`,
        element: (
      ...
      },
      {
        id: 'latest-period',
        title: 'Latest Period',
        description: 'Sales for the latest period',
        searchableContent: `Latest Period ${formatNumber(salesData.total_sales[salesData.periods[salesData.periods.length - 1]])}`,
        element: (
          <div className="p-4 bg-white border rounded-lg shadow-sm">
            <div className="flex items-center gap-x-3">
      ...
      },
      {
        ...
        searchableContent: `Sales Growth ${formatNumber(salesData.sales_growth[salesData.periods[salesData.periods.length - 1]])}%`,
        element: (
          <div className="p-4 bg-white border rounded-lg shadow-sm">
            <div className="flex items-center gap-x-3">
  ...
  return (
    <div className="p-4" ref={reportContainerRef}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        {filterCards(getKpiCards()).map(card => card.element)}
      </div>
